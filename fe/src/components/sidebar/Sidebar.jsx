            ...
            >
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                    ...
                    <div style={{ flex: 1, marginBottom: '32px' }}>
                        <Menu>
                            <MenuItem className={styles.menu_items} onClick={() => navigate('/home')}>Home</MenuItem>
                        </Menu>
                        <Menu>
                            <MenuItem onClick={handleOpenUserModal}>
                                <Image src={user ? user.profileImg : ''} roundedCircle style={{ maxHeight: '25px' }} />
